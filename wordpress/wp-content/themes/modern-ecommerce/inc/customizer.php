...
function modern_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('modern_ecommerce_logo_max_height',array(
		...
		$wp_customize->add_control(
			new Modern_Ecommerce_Customizer_Customcontrol_Switch(
				...
				array(
					...
					'section'         => 'modern_ecommerce_theme_settings',
					'label'           => __( 'Hide Scroll Top', 'modern-ecommerce' ),				
					'choices'		  => array(
						'1'      => __( 'On', 'modern-ecommerce' ),
						'off'    => __( 'Off', 'modern-ecommerce' ),
					),
	...
	$wp_customize->add_control(
		new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_theme_settings',
				'label'           => __( 'Hide Shop Page Sidebar', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
	...
	$wp_customize->add_control(
		new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_theme_settings',
				'label'           => __( 'Hide Single Product Page Sidebar', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
	...
	$wp_customize->add_control( new Modern_Ecommerce_Customizer_Customcontrol_Section( $wp_customize, 'modern_ecommerce_section_post_heading', array(
		'label'       => esc_html__( 'Post Structure', 'modern-ecommerce' ),
	...
	$wp_customize->add_control(new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_layout',
				'label'           => __( 'Hide Date', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
	...
	$wp_customize->add_control(new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_layout',
				'label'           => __( 'Hide Author/Admin', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
	...
	$wp_customize->add_control(new Modern_Ecommerce_Customizer_Customcontrol_Switch(
			...
			array(
				...
				'section'         => 'modern_ecommerce_layout',
				'label'           => __( 'Hide Comment', 'modern-ecommerce' ),				
				'choices'		  => array(
					'1'      => __( 'On', 'modern-ecommerce' ),
					'off'    => __( 'Off', 'modern-ecommerce' ),
				),
